...
<div class="button">
  ...
  <input type="submit" class="button" name="insert" value="insert"  />
    ...
    <?php
      ...
      $sql = $connection->prepare("SELECT Nickname1, Nickname2, ID FROM lobby");
      $sql->execute();
                   ...
                   <div class="card" style="width: 18rem;">
                     ...
                     <div class="card-body">
                       ...
                       <p class="card-text">Spieler1:
                         ...
                         if (empty($results['Nickname1'])){
                           echo "Kein Spieler 1";
                         }else{
                           echo $results['Nickname1'];
                         }
                         ?>
                       </p>
                       <p class="card-text">Spieler2:
                          ...
                          if (empty($results['Nickname2'])){
                            echo "Kein Spieler 2";
                          }else{
                            echo $results['Nickname2'];
                          }
                          ?>
                       </p>
