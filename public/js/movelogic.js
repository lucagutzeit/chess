...
function getKnightMoves(chesspiece,boardstate){
	...
	if(twiceTopHelp == 0 && rightHelp == 0 && boardstate[row-2][column+1] == ""){
		chesspiece.moves[counter] = [row-2,column+1];
		counter++;
	}
	// check if piece is an Enemy
	else if (twiceTopHelp == 0 && rightHelp == 0 && boardstate[row-2][column+1].color != chesspiece.color){
		chesspiece.moves[counter] = [row-2,column+1];
		counter++;
	} 
	// twiceRight top
	// check for free space
	if(twiceRightHelp == 0 && topHelp == 0 && boardstate[row-1][column+2] == ""){
		chesspiece.moves[counter] = [row-1,column+2];
		counter++;
	} 
	// check if piece is an Enemy
	else if(twiceRightHelp == 0 && topHelp == 0 && boardstate[row-1][column+2].color != chesspiece.color){
		chesspiece.moves[counter] = [row-1,column+2];
		counter++;
	}
	// twiceRight bottom
	// check for free space
	if(twiceRightHelp == 0 && bottomHelp == 0 && boardstate[row+1][column+2] == ""){
		chesspiece.moves[counter] = [row+1,column+2];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceRightHelp == 0 && bottomHelp == 7 && boardstate[row+1][column+2].color != chesspiece.color){
		chesspiece.moves[counter] = [row+1,column+2];
		counter++;
	}
	// twiceBottom right
	// check for free Space
	if(twiceBottomHelp == 0 && rightHelp == 0 && boardstate[row+2][column+1] == ""){
		chesspiece.moves[counter] = [row+2,column+1];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceBottomHelp == 0 && rightHelp == 0 && boardstate[row+2][column+1].color != chesspiece.color){
		chesspiece.moves[counter] = [row+2,column+1];
		counter++;
	}
	// twiceBottom left
	// check for free space
	if(twiceBottomHelp == 0 && leftHelp == 0 && boardstate[row+2][column-1] == ""){
		chesspiece.moves[counter] = [row+2,column-1];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceBottomHelp == 0 && leftHelp == 0 && boardstate[row+2][column-1].color != chesspiece.color){
		chesspiece.moves[counter] = [row+2,column-1];
		counter++;
	}
	// twiceLeft bottom
	// check for free space
	if(twiceLeftHelp == 0 && bottomHelp == 0 && boardstate[row+1][column-2] == ""){
		chesspiece.moves[counter] = [row+1,column-2];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceLeftHelp == 0 && bottomHelp == 0 && boardstate[row+1][column-2].color != chesspiece.color){
		chesspiece.moves[counter] = [row+1,column-2];
		counter++;
	}
	// twiceLeft top
	// check for free space
	if(twiceLeftHelp == 0 && topHelp == 0 && boardstate[row-1][column-2] == ""){
		chesspiece.moves[counter] = [row-1,column-2];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceLeftHelp == 0 && topHelp == 0 && boardstate[row-1][column-2].color != chesspiece.color){
		chesspiece.moves[counter] = [row-1,column-2];
		counter++;
	}
	// twiceTop left
	// check for free space
	if(twiceTopHelp == 0 && leftHelp == 0 && boardstate[row-2][column-1] == ""){
		chesspiece.moves[counter] = [row-2,column-1];
		counter++;
	} 
	// check if piece is an Enemy
	else if (twiceTopHelp == 0 && leftHelp == 0 && boardstate[row-2][column-1].color != chesspiece.color){
		chesspiece.moves[counter] = [row-2,column-1];
		counter++;
	}
}
...
function getKingMoves(chesspiece,boardstate){
	...
	// check if Piece on the Board is an enemy
	else if (leftHelp == 0 && boardstate[row][column - 1].color != chesspiece.color){
		chesspiece.moves[counter] = [row, column - 1];
		counter++;
	}
	//right
	...
	//check if Piece on the board is an enemy
	else if (rightHelp == 0 && boardstate[row][column + 1].color != chesspiece.color){
		chesspiece.moves[counter] = [row, column + 1];
		counter++;
	}
	//top
	...
	//check if Piece on the board is an enemy
	else if(topHelp == 0 && boardstate[row - 1][column].color != chesspiece.color){
		chesspiece.moves[counter] = [row - 1, column];
		counter++;
	} 
	//bottom
	...
	//check if Piece on the board is an enemy
	else if(bottomHelp == 0 && boardstate[row + 1][column].color != chesspiece.color){
		chesspiece.moves[counter] = [row + 1, column];
		counter++;
	}
	//leftTop
	...
	// check if Piece on the Board is an enemy
	else if (leftTopHelp == 0 && boardstate[row-1][column-1].color != chesspiece.color){
		chesspiece.moves[counter] = [row-1, column-1];
		counter++;
	}
	//rightTop
	...
	// check if Piece on the Board is an enemy
	else if (rightTopHelp == 0 && boardstate[row-1][column+1].color != chesspiece.color){
		chesspiece.moves[counter] = [row-1, column+1];
		counter++;
	}
	//leftBottom
	...
	// check if Piece on the Board is an enemy
	else if (leftBottomHelp == 0 && boardstate[row+1][column-1].color != chesspiece.color){
		chesspiece.moves[counter] = [row+1, column-1];
		counter++;
	}
	//rightBottom
	...
	// check if Piece on the Board is an enemy
	else if (rightBottomHelp == 0 && boardstate[row+1][column+1].color != chesspiece.color){
		chesspiece.moves[counter] = [row+1, column+1];
		counter++;
	}
}
